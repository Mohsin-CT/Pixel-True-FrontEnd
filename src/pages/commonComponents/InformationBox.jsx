...
const InformationBox = () => {
  ...
  return (
    <div
      className={`flex justify-center px-[20px] md:px-[50px] lg:px-[100px]   ${
        location === "individualBlog"
          ? "bg-green-150"
          : "p-0 bg-orange-50"
      }`}
    >
      <div className="w-full max-w-[1396px] mx-auto py-[100px]">
        <div className="flex flex-col text-[20px] xl:text-[24px] text-gray-850 font-[400] gap-10">
          <p>
