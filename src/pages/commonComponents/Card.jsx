...
export default function Card(props) {
  ...
  return (
    <div className="flex pb-6 flex-col gap-5 relative">
      <button className="absolute px-6 py-1 text-[18px] lg:text-[20px] text-white font-[600] bg-opacity-70 rounded-md bg-lightgreen-150 top-8 left-8 ">
        Service
      </button>
      ...
      <div className="flex px-6 flex-col gap-5">
        ...
        <p className="text-[18px] xl:text-[20px] font-[400] leading-[1.6]">
          {props.data.desc}
        </p>
